...
const MODEL_COLORS: Record<string, string> = {
  XGBoost: '#60a5fa', HistGradientBoosting: '#a78bfa', ExtraTrees: '#f0b429',
};
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p>3-model ensemble with Adaptive Detector Score (ADS) weighting</p>
      </div>
        ...
        <div className="tab-panel">
          <div className="card">
            ...
            <p style={{ fontSize: 13, lineHeight: 1.8, color: '#c8d8c8', marginBottom: 16 }}>
              This module implements a <strong style={{ color: '#6ec47e' }}>3-model adaptive ensemble</strong> for fraud detection.
              Each model (XGBoost, HistGradientBoosting, Extra Trees)
